 ...
 * @returns {boolean}
 */
var isConfig = function isConfig(config, option) {
    var allowParams = new Set(config);
 ...
 * @description 自动标注星级
 */
var autoRate = function autoRate(option) {
    var rateNode = document.querySelectorAll(".rate-auto");
    for (var i = 0; i < rateNode.length; i++) {
        var config = {};
        var type = rateNode[i].getAttribute('disabled') === 'disabled' ? 'show' : 'rate';
        var all = rateNode[i].dataset.all ? Number(rateNode[i].dataset.all) : 5;
        var num = rateNode[i].dataset.num ? Number(rateNode[i].dataset.num) : rateNode[i].dataset.all;
        var color = rateNode[i].dataset.color ? Number(rateNode[i].dataset.color) : 'orangered';
    ...
    if (option) {
        switch (option.type) {
            ...
            case "show":
                ...
                //创建DOM
                var showNode = document.createElement('ul');
                ...
                for (var _i = option.num; _i < option.all; _i++) {
            ...
            case "rate":
                ...
                option.color = option.color ? option.color : 'orangered';
                //创建DOM
                var rateNode = document.createElement('ul');
                rateNode.classList.add('yu-rate');
                rateNode.setAttribute("data-rate", option.num);
                rateNode.setAttribute("style", 'color:' + option.color);
                for (var _i2 = 0; _i2 < option.num; _i2++) {
                    rateNode.innerHTML += '<li data-id="' + _i2 + '"><i class="iconfont icon-star-f"></i></li>';
                }
                for (var _i3 = option.num; _i3 < option.all; _i3++) {
                    rateNode.innerHTML += '<li data-id="' + _i3 + '"><i class="iconfont icon-star"></i></li>';
                }
                option.target.appendChild(rateNode);
                var list = option.target.querySelectorAll("ul.yu-rate li");
                for (var _i4 = 0; _i4 < list.length; _i4++) {
                    list[_i4].onclick = function () {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_autoprefixer-loader@3.2.0@autoprefixer-loader/index.js!./rate.scss", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../node_modules/_autoprefixer-loader@3.2.0@autoprefixer-loader/index.js!./rate.scss");
...
// imports
exports.push([module.i, "@import url(http://at.alicdn.com/t/font_429499_vmpa9kfph060f6r.css);", ""]);

// module
exports.push([module.i, ".yu-rate {\n  margin: 0;\n  padding: 0;\n  color: orangered; }\n  .yu-rate li {\n    display: inline-block;\n    list-style: none;\n    color: inherit;\n    font-size: 20px;\n    cursor: pointer; }\n    .yu-rate li + li {\n      margin-left: 3px; }\n    .yu-rate li .iconfont {\n      font-size: inherit; }\n", ""]);
